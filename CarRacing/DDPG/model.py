...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, fc1_dims, fc2_dims, n_actions, name,
        ...
        self.cnn_out = self.calc_input_dims()

        self.fc1 = nn.Linear(self.cnn_out, self.fc1_dims)
    ...
    def forward(self, state, action):
        ...
        state_value = F.relu(self.conv4(state_value))
        #print(state_value.shape)
        #print(action.shape)
        state_value = state_value.view(state_value.size(0), 32 * 2 * 2)
...
class ActorNetwork(nn.Module):
    def __init__(self, alpha, input_dims, fc1_dims, fc2_dims, n_actions, name,
        ...
        self.conv1 = nn.Conv2d(self.input_dims, 32, 3)
...
class Agent(object):
    def __init__(self, alpha, beta, input_dims, tau, observation_shape, env, gamma=0.99,
                n_actions=2, max_size=100000, layer1_size=400,
                layer2_size=300, batch_size=64):

        self.gamma = gamma
        self.tau = tau
        self.memory = ReplayBuffer(max_size,observation_shape, n_actions)
    ...
    def choose_action(self, observation):
        ...
        probabilities = F.softmax(mu_prime)
    ...
    def learn(self):
        ...
        # print("Learn shape 1 state: ",state.shape)
        ...
        #print('Shape act: ', action.shape)
        #print('Shape rewa: ', reward.shape)
        #print(action)
