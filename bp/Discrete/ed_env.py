...
class CarRacing(gym.Env, EzPickle):
    ...
    def step_discrete(self,action_n):
        return self.step(self.make_continuous_action(action_n))
    ...
    def render(self, mode='human'):
        ...
        #self.render_indicators(WINDOW_W, WINDOW_H)   #Indicators rendering tmporalily turned off
...
def human_control():
    ...
    def key_press(k, mod):
        ...
        if k==key.UP:    a[1] = +0.7
        if k==key.DOWN:  a[2] = +0.4   # set 1.0 for wheels to block to zero rotation
